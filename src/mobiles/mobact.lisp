...
(defun can-travel-terrain (ch terrain)
  (or (immortalp ch)
      (and (terrain-has-water terrain)
           (is-race ch +race-fish+))
      (and (= terrain +sect-water-noswim+)
      ...
      (and (terrain-has-water terrain)
           (or
            ...
            (and (is-elemental ch) (is-class ch +class-water+))))
      (and (not (terrain-has-air terrain))
           (not (needs-to-breathe ch)))
      (and (terrain-is-open-air terrain)
           (or (aff-flagged ch +aff-inflight+)
