  ...
  (let ((stats (make-array 6 :initial-element 12)))
    ...
    (let ((priorities (cond
      ...
      (loop
         ...
         do (case stat
              (:str
               (setf (str-of (real-abils-of ch)) (aref stats idx)))
              (:int
               (setf (int-of (real-abils-of ch)) (aref stats idx)))
              (:wis
               (setf (wis-of (real-abils-of ch)) (aref stats idx)))
              (:dex
               (setf (dex-of (real-abils-of ch)) (aref stats idx)))
              (:con
               (setf (con-of (real-abils-of ch)) (aref stats idx)))
              (:cha
               (setf (cha-of (real-abils-of ch)) (aref stats idx)))))))
  (cond
    ((or (eql (race-of ch) +race-elf+)
         (eql (race-of ch) +race-drow+))
     (incf (int-of (real-abils-of ch)))
     (incf (dex-of (real-abils-of ch)))
     (decf (con-of (real-abils-of ch))))
    ((eql (race-of ch) +race-halfling+)
     (decf (str-of (real-abils-of ch)) 2)
     (incf (dex-of (real-abils-of ch)) 2))
    ((eql (race-of ch) +race-dwarf+)
     (incf (con-of (real-abils-of ch)))
     (incf (str-of (real-abils-of ch)))
     (decf (cha-of (real-abils-of ch))))
    ((eql (race-of ch) +race-half-orc+)
     (incf (str-of (real-abils-of ch)) 2)
     (incf (con-of (real-abils-of ch)))
     (decf (cha-of (real-abils-of ch)) 3))
    ((eql (race-of ch) +race-orc+)
     (incf (str-of (real-abils-of ch)))
     (incf (con-of (real-abils-of ch)))
     (decf (int-of (real-abils-of ch)))
     (decf (wis-of (real-abils-of ch)) 2)
     (decf (cha-of (real-abils-of ch)) 3))
    ((eql (race-of ch) +race-tabaxi+)
     (incf (dex-of (real-abils-of ch)) 3)
     (incf (con-of (real-abils-of ch)))
     (decf (int-of (real-abils-of ch)))
     (decf (wis-of (real-abils-of ch)) 3)
     (decf (cha-of (real-abils-of ch)) 2))
    ((eql (race-of ch) +race-minotaur+)
     (incf (str-of (real-abils-of ch)) 3)
     (incf (con-of (real-abils-of ch)) 2)
     (decf (wis-of (real-abils-of ch)) 3)
     (decf (int-of (real-abils-of ch)) 2)
     (decf (cha-of (real-abils-of ch)) 2))
