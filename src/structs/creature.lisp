...
(defclass affected-type ()
  ((kind :accessor kind-of :initarg :kind :initform nil :type (integer 0 2048))
   (duration :accessor duration-of :initarg :duration :initform nil :type (integer 0 2048))
   (modifier :accessor modifier-of :initarg :modifier :initform nil :type (integer -10000 10000))
