...
(defclass room-data ()
  ((number :accessor number-of :initarg :number :initform nil)
   ...
   (prog-obj :accessor prog-obj-of :initarg :prog-obj :initform nil)
   ...
   (flags :accessor flags-of :initarg :room-flags :initform 0)
   ...
   (flow-dir :accessor flow-dir-of :initarg :flow-dir :initform 0)
   (flow-speed :accessor flow-speed-of :initarg :flow-speed :initform 0)
   (flow-kind :accessor flow-kind-of :initarg :flow-kind :initform 0)
